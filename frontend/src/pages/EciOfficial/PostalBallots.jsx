...
import monitorImage from '../../assets/moniter3.png';
import monitorImage2 from '../../assets/moniter4.png';
import monitorImage3 from '../../assets/moniter5.png';

const listitems = [
  {
    title: "Secure transmission of e-Postal Ballot using end-to-end encryption",
  },
  {
    title: "Multi-factor authentication and validation to prevent duplicate or tampered ballots",
  },
  {
    title: "Support for both Assembly (AC) and Parliamentary (PC) elections",
  },
  {
    title: "Integrated platform for online and offline permission requests",
  },
  {
    title: "Automated routing of permission requests to designated nodal officers",
  },
  {
    title: "Dedicated mobile application for nodal officers with role-based access",
  },
  {
    title: "Capability to assign multiple nodal officers per permission category",
  },
  {
    title: "Real-time tracking and audit trail of permission request lifecycle",
  },
];
...
All the digitized permission and online received permission request will be sent to the concerned officer and nodal officer of different departments for approval through the ENCORE system. The ECI has separately provided a Nodal App to the Nodal officers of the other departments whose consent is required before approval of any permission. The candidate/political parties can also track their application status through the Candidate App from Google Play Store. Once the permission request gets approved, the same permission copy can be downloaded from the application as well as Suvidha Portal.
       ...
       <p className="text-md mt-3 font-bold ">
        ...
        {/*Affidavit Montior Image */}
     <div className="flex justify-content-center my-3 " style={{ height: '300px' }}>
      <img src={monitorImage2} alt="" className="h-[300px] inline-block" />
      <img src={monitorImage3} alt="" className="h-[300px] inline-block"/>
     </div>
      <div className="mt-5">
