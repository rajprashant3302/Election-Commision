...
const SearchName2003 = () => {
  ...
  return (
    ...
    <div className='parent1 rounded-2xl m-2  grid  justify-center gap-3 grid-cols-1 md:grid-cols-5'> 
     ...
     <div>
     <h3 className='block text-lg font-bold pb-2 pt-2.5 pl-5'>Homepage</h3>
     <label className='pl-5' htmlFor="state">Select your state:</label>
      <select className='bg-slate-200 ml-5 mb-5 w-44 md:w-32' id="state" value={state} onChange={handleChange}>
