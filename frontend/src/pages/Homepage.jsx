  ...
  return (
    ...
    <div className='parent1 rounded-2xl m-2  grid gap-3 grid-cols-1 md:grid-cols-5'> 
      <div className="forms bg-[#d3e1ee] col-span-3 rounded-2xl">
        ...
        <div className='p-2'><img src="../../src/assets/new_voter_reg.svg" className='w-24' alt="EF form image"/></div>
        <div>
            ...
            <div className='flex flex-wrap text-sm  m-2'>
                <Link to='#'><button className='btn bg-[#FF64D1] text-white hover:bg-[#fc81d7] text-nowrap h-fit my-2 mx-1 flex items-center'>Fill form 6 <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
                <Link to='#'><button className='btn bg-[#FF64D1] text-white hover:bg-[#fc81d7] text-nowrap h-fit my-2 mx-1 flex items-center'>Fill Annexure D (Bihar) <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
                <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center '> < img src="../../src/assets/download.svg" alt="download_icon"/> Download </Link>
                <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'>Guidelines <img src="../../src/assets/arrow_outward.svg" alt="link_arrow"/> </Link>
                <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'><img src="../../src/assets/download.svg" alt="download_icon"/> Download Annexure D for Pre drafts Forms </Link>
       ...
       <div className='flex w-full justify-between gap-3'>
       <div className='p-2'><img src="../../src/assets/new_voter_reg_nri.svg" className='w-32' alt="EF form image"/></div>
            <div>
            ...
            <Link to='#'><button className='btn bg-[#2bb9e9] text-white hover:bg-[#5ed1f8] text-nowrap h-fit my-2 mx-1 flex'>Fill form 6A <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
            <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'> < img src="../../src/assets/download.svg" alt="download_icon"/> Download </Link>
            <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'>Guidelines <img src="../../src/assets/arrow_outward.svg" alt="link_arrow"/> </Link>
            </div>
        </div>
        ...
        <div className='flex flex-wrap  m-2 text-sm'>
        <Link to='#'><button className='btn bg-[#ef4040] text-white hover:bg-[#ff6363] text-nowrap h-fit my-2 mx-1 flex'>Fill form 7 <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
        <Link to='#'><button className='btn bg-[#ef4040] text-white hover:bg-[#ff6363] text-nowrap h-fit my-2 mx-1 flex'>Fill form 7 Overseas <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
        <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'> < img src="../../src/assets/download.svg" alt="download_icon"/> Download </Link>
            <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'>Guidelines <img src="../../src/assets/arrow_outward.svg" alt="link_arrow"/> </Link>
        ...
        <div className='flex w-full justify-between gap-3'>
        <div className='p-2'><img src="../../src/assets/correction_entries.svg" className='w-24' alt="EF form image"/></div>
        <div>
            ...
            <div className='flex flex-wrap  m-2 text-sm'>
            <Link to='#'><button className='btn bg-[#64c118] text-white hover:bg-[#85cb4c] text-nowrap h-fit my-2 mx-1 flex'>Fill form 8 <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
            <Link to='#'><button className='btn bg-[#64c118] text-white hover:bg-[#85cb4c] text-wrap h-fit my-2 mx-1 flex'>Fill form 8 Overseas (Self correction only) <img src="../../src/assets/arrow_outward_white.svg" alt="link_arrow"/></button></Link>
            ...
            <Link to='#' className='w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'> < img src="../../src/assets/download.svg" alt="download_icon"/> Download Annexure D for Pre-Draft Forms</Link>
        ...
        <div className='flex w-full justify-between gap-3'>
          <div className='p-2'><img src="../../src/assets/formMFilled.e9ca2cc6ea8f984c8d2f19dad6867828.svg" className='w-48' alt="EF form image"/></div>
            <div>
        ...
        <div className='flex w-full justify-between gap-3'>
        <div className='p-2'><img src="../../src/assets/form12CFilled.5e7922ab27299aa48c714bfbc5946052.svg" className='w-32' alt="EF form image"/></div>
        <div>
      ...
      <div className="box1 cursor-pointer transition transform ease-in duration-200 hover:scale-105   border-2 rounded m-2.5 bg-[#E4F6FC] border-[#2BB9E9] flex flex-col ">
       ...
       <Link to='#' className=' w-fit my-1 mx-2 hover:underline hover:text-blue-700 flex items-center'>Chatbot Manual <img src="../../src/assets/arrow_outward.svg" alt="link_arrow"/> </Link>
        <img src="../../src/assets/human.4930cada2dd2f2a8e989.png" className='w-14' alt="help_image"/>
            </div>
    ...
    <div className='p-2 '><img src="../../src/assets/faqIconQuestionMark.2c1c2634ce5a1110be2035bdc09cb96c.svg" className='w-16 rounded-[50%]' alt="EF form image"/></div>
           <div>
     ...
     <div className='flex items-center gap-8'>
    <div className='p-2 '><img src="../../src/assets/logo.png" className='w-20 rounded-[50%]' alt="EF form image"/></div>
           <div>
     ...
     <div className='flex items-center gap-8'>
    <div className='p-2 '><img src="../../src/assets/initiative.936e61731030637d83f7.png" className='w-16 rounded-[0%]' alt="EF form image"/></div>
           <div>
                <h3 className='text-lg font-bold pb-2 pt-2.5 pl-1.5 flex'>ECINet App  < img src="../../src/assets/androidLogoNewIcon.1571c08df386b2aee9c0acb18b4f75cb.svg" className='mx-2.5' alt="android_logo"/> < img src="../../src/assets/appleLogoNewIcon.c3241d824b62415d195c2363f77dfeb5.svg" alt="mac_logo"/></h3>
            </div>
    </div>
        </div>
     </Link>
     ...
     <div className='flex items-center gap-8'>
    <div className='p-2 '><img src="../../src/assets/ecinet_logo.345a0e531054a16b90b4.png" className='w-16 rounded-[50%]' alt="EF form image"/></div>
           <div>
                <h3 className='text-lg font-bold pb-2 pt-2.5 pl-1.5 flex'>30 Initiatives of ECI  < img src="../../src/assets/download.svg" alt="download_icon"/></h3>
            </div>
    </div>
        </div>
     </Link>
    ...
    <div className="box1 relative border-2 rounded m-2.5 bg-[#DBF7C4] border-[#64C118] flex flex-col w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3">
           ...
           <Link to='#'><button className='btn text-sm items-center gap-1 bg-[#ebeaea] text-black hover:bg-[#ffffff] text-nowrap h-fit my-2 mx-1 flex'>View Results <img src="../../src/assets/arrow_outward.svg" alt="link_arrow"/></button></Link>
           <Link to='#'><button className='btn text-sm items-center gap-1 bg-[#ebeaea] text-black hover:bg-[#ffffff] text-nowrap h-fit my-2 mx-1 flex'>View Report <img src="../../src/assets/arrow_outward.svg" alt="link_arrow"/></button></Link>
           </div>
    ...
    <div className="box3 col-span-2 mx-2 border-2 rounded m-2.5  bg-[#FDE2F5] border-[#FF64D1] flex flex-col h-fit w-fit">
      ...
      <div>
            <div>
                ...
                <div className='p-2 '><img src="../../src/assets/call.svg" className='w-8 rounded-[0%]' alt="EF form image"/></div>
        ...
        <div>
            <div>
                <div className='flex items-center gap-2'>
                <div className='p-2 '><img src="../../src/assets/post.svg" className='w-8 rounded-[0%]' alt="EF form image"/></div>
        ...
        <div>
            <div>
                <div className='flex items-center gap-2'>
                <div className='p-2 '><img src="../../src/assets/mail.svg" className='w-8 rounded-[0%]' alt="EF form image"/></div>
    ...
    <div class="footer bg-[#d3e1ee] rounded mt-3">
        <div className='flex justify-between mx-3'>
            <div className='flex items-center gap-2'>
            <div className='p-2 '><img src="../../src/assets/sound.svg" className='w-8 rounded-[0%]' alt="sound_image"/></div>
            <Link className='underline cursor-pointer text-blue-700' to="#">ECI Updates</Link>
            </div>
            <div className='flex items-center gap-2'>
            <div className='p-2 '><img src="../../src/assets/contact_dir.svg" className='w-8 rounded-[0%]' alt="contact_dir_image"/></div>
