...
const Footer = () => {
    return (
        <footer className="bg-[#004274] text-white">
            <div className="max-w-7xl mx-auto  py-10">
                <div className="flex flex-col lg:flex-row lg:space-x-10">

                    {/* QR Code on left */}
                    <div className="flex-shrink-0 mb-10 lg:mb-0 lg:w-1/5">
                    ...
                    <div className="flex flex-grow justify-between text-center lg:text-left space-x-4">
                        <div className="w-1/4">
                            ...
                            <ul className="space-y-1 text-sm font-semibold">
                                <li>
                                    <a href="#" className="text-white hover:text-yellow-300 active:text-yellow-400 transition-colors duration-200">
                ...
                <div className="mt-8 text-center text-sm font-semibold">
                    <p>
                        Home &nbsp; |&nbsp; Gallery &nbsp;|&nbsp; Assets Declaration &nbsp;|&nbsp; ECI Mobile Apps &nbsp; |&nbsp; Contact Us &nbsp;|&nbsp;
                        Site Map
                    </p>
                    <p className="mt-1">
