...
export default function ICTApplications() {
  return (
    ...
    >
      <h2 className="sm:text-5xl text-3xl  font-bold text-center mb-12 text-center w-full  p-4  font-bold   mt-0.5 mb-2 bg-gradient-to-b from-white via-white to-black-300 bg-clip-text text-transparent">
        ICT Applications
      </h2>
