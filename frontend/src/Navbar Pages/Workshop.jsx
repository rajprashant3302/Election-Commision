...
const items = [
  {
    title: "Workshop Photo Gallery",
    link: "https://ceoelection.bihar.gov.in/workshop/gallery/gallery_ws.html",
  },
  {
 ...
 {
   title: "Samadan,Suvidha and Sugam",
   link: "#",
 },
  {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-6">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 border-b-2 pb-2">
            State level Workshop for PwDs facilitation and Electoral Awareness-2019
          </h2>
